...
function Container(_a) {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement("div", { className: "flex flex-col p-8 md:px-20 bg-gradient-to-b from-fuchsia-900 via-purple-600 to-[#2D30F0] w-full text-white" },
            ...
            react_1["default"].createElement("div", { className: "mx-auto md:w-min md:min-w-fit" },
                ...
                react_1["default"].createElement("div", { className: "text-center mt-auto text-white" },
