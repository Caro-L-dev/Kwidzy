...
function quizdetailPage() {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement("div", { className: " flex mb-4 items-center" },
        ...
        react_1["default"].createElement("div", { className: "flex flex-col justify-between" },
            react_1["default"].createElement("div", { className: "md:flex md:mb-10" },
                react_1["default"].createElement("div", null,
                    react_1["default"].createElement("div", { className: "hidden md:block h-[73px] md:h-full md:w-[580px] p-4 font-bold text-xl rounded-2xl my-4 bg-fixed bg-numerique bg-no-repeat bg-cover bg-center" })),
